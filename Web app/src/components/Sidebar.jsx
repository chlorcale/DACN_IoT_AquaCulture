...
export default function Sidebar({ page, setPage }) {
  return <aside className="sidebar">
    ...
    <div className="account-card pixel-corners-sm"><div className="account-row"><div className="avatar">HP</div><div><div className="account-name">Operator</div><div className="account-role">Pond technician</div></div></div><div className="account-status"><span className="led" />Server session active</div></div>
